...
const ProductDetails = () => {
  ...
  const handleWishlist=(e:any)=>{
    e.stopPropagation();
    productId && dispatch(addproductToWishlist({ productId: Number(productId) }));
  }

  const handleAddtoCart=(e:any)=>{
    e.stopPropagation();
    productId && dispatch(addItemToCart({jwt:localStorage.getItem("jwt") ?? "", 
      request:{productId:Number(productId),quantity,size:product.product?.sizes || ""}}));
  }
        ...
        <section>
          ...
          <div>
            <div className="price flex items-center gap-3 text-2xl">
              ...
              <span className="thin-line-through text-gray-400">₹ {product.product?.mrpPrice}</span>
              <span className="text-primary-color">{product.product?.discountPercent}%</span>
            </div>
            <p className="text-sm">
          ...
          <div className="mt-7 space-y-3">
            <div className="flex items-center gap-4">
              ...
              <p>Authentic & Qauality Assured</p>
            </div>
            <div className="flex items-center gap-4">
          ...
          <div className="mt-7 space-y-2">
            ...
            <div className="mt-12 flex items-center gap-5">
              ...
              <Button onClick={handleWishlist}
                variant={isWishlistHovered ? "contained" : "outlined"}
